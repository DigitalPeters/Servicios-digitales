...
async function loadAdminSubadminPrices(){
  try{
    ...
    if(!box) return;
    box.innerHTML=prices.length ? `<div class="table-wrap"><table class="mini-table"><thead><tr><th>Producto</th><th>Precio compra<br><span class="small-text">Último costo cargado</span></th><th>Precio vendedor</th><th>Precio distribuidor</th><th>Ganancia admin</th><th>Guardar</th></tr></thead><tbody>${prices.map(p=>{
      ...
      return `<tr>
        ...
        <td><b>$${formatMoney(purchaseCost)}</b><br><span class="small-text">Último costo del inventario</span></td>
